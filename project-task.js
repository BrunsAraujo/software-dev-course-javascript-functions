...
//SCRIPT 1 - WELCOMING MULTIPLE USERS
function greet(name){
    return `Welcome, `+ name + `!`;
}
...
const productNum1Num2 = function(num1, num2){
    return num1 * num2;
};
console.log(`The product of 5 and 10 is ` + productNum1Num2(5,10))
